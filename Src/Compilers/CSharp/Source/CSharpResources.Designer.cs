...
namespace Microsoft.CodeAnalysis.CSharp {
    ...
    internal class CSharpResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The implicit parameter &apos;{0}&apos; of method &apos;{1}&apos; is ambiguous, because there is more than one implicit symbol in scope with a suitable type..
        /// </summary>
        internal static string ERR_AmbiguousImplicitParameterArgument {
            get {
                return ResourceManager.GetString("ERR_AmbiguousImplicitParameterArgument", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The implicit parameter &apos;{0}&apos; of method &apos;{1}&apos; cannot be resolved, because there is no implicit symbol in scope with a suitable type..
        /// </summary>
        internal static string ERR_NoSuitableImplicitArgumentInScope {
            get {
                return ResourceManager.GetString("ERR_NoSuitableImplicitArgumentInScope", resourceCulture);
            }
        }
